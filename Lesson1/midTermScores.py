...
average_Finals = sum(final_scores) / num_final_scores
print(f'Average Midterm score: {round(average_Midterm,2)}')
print(f'Average Finals score: {round(average_Finals,2)}')
